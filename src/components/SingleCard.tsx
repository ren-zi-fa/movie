    ...
    <div style={style} className="p-2">
      <Card className="h-full rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 flex flex-col group overflow-hidden">
        ...
        <div className="relative overflow-hidden rounded-t-2xl">
          {imageLoading && (
            <Skeleton className="w-full h-[180px] absolute inset-0 z-10" />
          )}
          <Image
            ...
            className={`rounded-t-2xl object-cover w-full h-[180px] transition-transform duration-300 group-hover:scale-105 ${
